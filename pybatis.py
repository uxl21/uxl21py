...
"""
    Abstract class for client session
"""
class PySQLClientSession(metaclass=ABCMeta):
    ...
    @abstractmethod
    def selectList(self, queryId:str, parameter:Dict) -> List[Any]: ...
...
class OracleClientSession(PySQLClientSession):
    ...
    # implemented
    #
    def selectList(self, queryId:str, parameter:Dict=None) -> List[Any]:
